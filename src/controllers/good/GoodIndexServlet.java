...
/**
 * Servlet implementation class GoodIndexServlet
 */
...
public class GoodIndexServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Good> goods = em.createNamedQuery("getAllGoods", Good.class)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/good/index.jsp");
